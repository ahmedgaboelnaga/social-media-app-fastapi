...
---
Right — your README right now explains the **features** but doesn’t actually list the **endpoints**, their methods, and parameters.
The Swagger screenshots are useful visually, but text-based endpoint documentation is important for:

* **GitHub viewers who can’t or won’t open images**
...
Here’s how I’d add it under a new section:
